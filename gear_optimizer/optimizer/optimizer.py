...
def optimize_gear(user_input) -> list[GearWithStats]:
    ...
    strength = user_input.stats[gear_optimizer.constants.PLAYER_STRENGTH]
    min_constraints = user_input.stats[gear_optimizer.constants.MIN_CONSTRAINTS]
    weapon = Item(name=in_weapon[gear_optimizer.constants.NAME], strength=in_weapon[gear_optimizer.constants.STRENGTH],
                  constraints=in_weapon[gear_optimizer.constants.CONSTRAINTS], bonus=0)
    shield = Item(name=in_shield[gear_optimizer.constants.NAME], strength=in_shield[gear_optimizer.constants.STRENGTH],
                  constraints=in_shield[gear_optimizer.constants.CONSTRAINTS],
                  bonus=in_shield_stats[gear_optimizer.constants.BONUS],
                  fire=in_shield_stats[gear_optimizer.constants.FIRE],
                  frost=in_shield_stats[gear_optimizer.constants.FROST],
                  poison=in_shield_stats[gear_optimizer.constants.POISON],
                  ether=in_shield_stats[gear_optimizer.constants.ETHER])
